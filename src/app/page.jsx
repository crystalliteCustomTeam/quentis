          ...
          <div className="container">
            <div className="grid grid-cols-1 gap-y-10 lg:gap-y-0 lg:grid-cols-2 gap-x-10 items-center">
              <div className="relative">
                ...
                <h2 className="text-[50px] font-bold leading-tight absolute top-1/3 left-[50px] sm:left-[100px] after:content-[''] after:absolute after:w-[80px] after:h-[80px] after:bg-primary/50 after:left-[105px] after:z-[-1] after:top-[20px] hover:after:left-[200px] after:transition-all hover:after:bg-primary">
                  About Us
                </h2>
              </div>
              <div>
                ...
                <p className="mt-5 mb-5">
                  Quentis is a full-service software and digital marketing company committed to
                  delivering innovative and results-driven solutions for businesses of all sizes.
                  With expertise spanning digital marketing, branding, SEO, book design and
                  publishing, and creative design services, we empower our clients to grow, connect,
                  and thrive in the digital space. At Quentis, we combine creativity with
                  data-driven strategies to build lasting brand experiences that drive measurable
                  success.
                </p>
                <p className="mb-5">
                  Founded with a vision to be a one-stop hub for modern digital needs, Quentis has
                  grown into a trusted partner for businesses seeking cutting-edge technology and
                  marketing support. Our team of skilled professionals brings together technical
                  knowledge and marketing insight to craft customized solutions that align with each
                  client’s goals. Whether it’s designing a compelling book cover, launching a
                  digital campaign, or optimizing online presence, Quentis is your go-to partner for
